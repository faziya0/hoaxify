  ...
  return (
    <div className="card text-center">
        ...
        {inEditMode && (
          <div>
            ...
            <div>
              ...
              />
              <button className="btn btn-light d-inline-flex ms-1" onClick={() => setInEditMode(false)} disabled={pendingApiCall}>
      ...
      <Modal
        ...
        modalTitle={t('Delete My Account')}
        confirmButton={t('Delete My Account')}
        cancel={onClickCancel}
        confirm={onClickDeleteUser}
